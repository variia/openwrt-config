...
uci batch <<EOF
  ...
  set firewall.${FIREWALLZONE}_odns1.name=Allow-${NETWORKID}-OpenDNS-FamilyShield-1
  ...
  set firewall.${FIREWALLZONE}_odns2.name=Allow-${NETWORKID}-OpenDNS-FamilyShield-2
